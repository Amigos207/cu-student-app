...
class _LoginScreenState extends State<LoginScreen>
  ...
  Future<void> _handleLogin() async {
    ...
    HapticService.medium(); // подтверждение нажатия кнопки входа
    ...
    if (success) {
      ...
      // ── ADMIN SANDBOX: посев уведомлений при входе ────────────
      if (username == 'admin') {
        await MockDataService.seedNotificationsIfNeeded();
      }
      // ──────────────────────────────────────────────────────────
      ...
      HapticService.heavy(); // ошибка авторизации
                ...
                child: FadeTransition(
                  ...
                  child: SlideTransition(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Логотип — premium gradient badge
                        Center(
                          child: Container(
                            width: 84, height: 84,
                        ...
                        SizedBox(
                          ...
                          child: DecoratedBox(
                            decoration: BoxDecoration(
                              ...
                              color: _loading ? primary.withOpacity(0.5) : null,
